...
class ParallelModel2D(tf.keras.Model):
    # see https://www.tensorflow.org/api_docs/python/tf/keras/Model
    def __init__(self, config):
        super(ParallelModel2D, self).__init__()
        # define layers here
        self.config = config
        ...
        self.d1_1 = tf.keras.layers.Dense(1, activation='linear')
        self.d1_2 = tf.keras.layers.Dense(1, activation='linear')
